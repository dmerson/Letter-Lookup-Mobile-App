...
(function(parent) {
	var formViewModel = kendo.observable({
		...
		submit: function() {
			...
			var result = convert.GetWordValue(formViewModel.fields.letterEntered.toLowerCase());
			if (isNaN(result)) {
				formViewModel.fields.set("result", "Not valid word");
				return;
			}
					formViewModel.fields.set("result", result);
